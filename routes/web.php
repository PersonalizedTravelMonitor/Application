...
Route::get('trips/{trip}/tripParts/{tripPart}/travelerReportEvent/{event}/delete','UserReportController@removeTravelerReportEvent')->name('tripParts.removeTravelerReportEvent');
